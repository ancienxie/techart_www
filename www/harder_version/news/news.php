        ...
        <section class="news-block__section">
            <ul class="news-block__section-left">
                ...
                <li class="news-block__button">
                    <!-- /harder_version/news/news.php?id=<?=$row['id']?> -->
                    <a href="google.com" class="news-block__button--text">
                        <div id="arrow-3"></div>
                        НАЗАД К НОВОСТЯМ
                    </a>
                </li>
            ...
            <ul>
                <li>
                    <img class="news-block__section-right--img" src="photo_2024-07-08_09-13-32.jpg" alt="Картинка">
                </li>
            </ul>
        </section>
